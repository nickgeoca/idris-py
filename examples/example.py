...
def _idris_Python_46_Functions_46__36__46_(e0, e1, e2, e3, e4, e5):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46_Monad_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      None,
      (65739, None),  # {U_Python.IO.unRaw1}
      (65737, e3, e2, e5)  # {U_Python.Functions.{$.0}1}
    )

# Python.Functions.$:
def _idris_Python_46_Functions_46__36__58_(e0, e1, e2, e3, e4, e5):
  while True:
    return (65769, None, None, None, e3, (65738, e2, e5))  # {U_io_bind1}, {U_Python.Functions.{$:0}1}
...
def _idris_Python_46_Fields_46__47__46_(e0, e1, e2, e3, e4):
  while True:
    return _idris_unsafePerformIO(None, None, (65735, e2, e3))  # {U_Python.Fields.{/.0}1}
...
def _idris_Prelude_46_Monad_46__62__62__61_(e0, e1, e2, e3):
  while True:
    ...
    in0, in1 = e1[1:]
    return APPLY0(APPLY0(in1, e2), e3)
    return _idris_error("unreachable due to case in tail position")

# @@constructor of Prelude.Algebra.Monoid#Semigroup ty
def _idris__64__64_constructor_32_of_32_Prelude_46_Algebra_46_Monoid_35_Semigroup_32_ty(
  e0, e1
):
  while True:
...
def _idris_Python_46_Exceptions_46_catch(e0, e1, e2):
  while True:
    return (65769, None, None, None, e1, (65714, e2))  # {U_io_bind1}, {U_Python.Exceptions.{catch6}1}
  ...
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46_Monad_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      _idris_Python_46_Prim_46_foreach(
        ...
        e2,
        ConsList(),
        (65750,),  # {U_Python.Prim.{collect1}1}
        None
      )
    )
...
def _idris_Python_46_Prim_46_foreach(e0, e1, e2, e3, e4, e5, e6):
  while True:
    return (
      ...
      (65752, e3, e4, e5)  # {U_Python.Prim.{foreach1}1}
    )
  ...
  while True:
    return (
      ...
      _idris_Python_46_Functions_46__36__58_(
        None,
        None,
        (1, (1,), (65741,)),  # Python.Telescope.Bind, Python.Telescope.Forall, {U_Python.Lib.Threading.{forkPIO1}1}
        _idris_Python_46_Fields_46__47__58_(
          None,
          None,
          (65767, None, u'Queue'),  # {U_Python.importModule1}
          u'Queue',
          None
        ),
        None,
      ...
      (65746, e1)  # {U_Python.Lib.Threading.{forkPIO6}1}
    )
...
def _idris_Python_46_Prim_46_iterate(e0, e1, e2, e3, e4, e5, e6):
  while True:
    return (
      ...
      (65753, e4, e5)  # {U_Python.Prim.{iterate0}1}
    )
...
def _idris_Prelude_46_Strings_46_length():
  while True:
    return (
      ...
      None,
      None,
      (65702, None, None, None, (65707,), (65773,)),  # {U_Prelude.Basics..1}, {U_Prelude.Strings.{length0}1}, {U_prim__zextInt_BigInt1}
...
def _idris_Main_46_main():
  while True:
    return (65769, None, None, None, (65767, None, u'requests'), (65695,))  # {U_io_bind1}, {U_Python.importModule1}, {U_Main.{main45}1}

# Python.marshalPIO
def _idris_Python_46_marshalPIO(e0, e1):
  while True:
    return _idris_unsafePerformIO(None, None, (65768, e1))  # {U_Python.{marshalPIO0}1}
...
def _idris_Prelude_46_Interactive_46_putStr_39_(e0, e1):
  while True:
    return (65769, None, None, None, (65775, None, e1), (65704,))  # {U_io_bind1}, {U_prim_write1}, {U_Prelude.Interactive.{putStr'0}1}
...
def _idris_Python_46_Exceptions_46_raise(e0, e1):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46_Monad_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      (65739, None),  # {U_Python.IO.unRaw1}
      (65715, e1)  # {U_Python.Exceptions.{raise0}1}
    )
...
def _idris_Python_46_Exceptions_46_showException(e0):
  while True:
    return _idris_unsafePerformIO(None, None, (65716, e0))  # {U_Python.Exceptions.{showException0}1}
...
def _idris_Python_46_Exceptions_46_try(e0, e1):
  while True:
    return (65769, None, None, None, (65729, e1), (65725,))  # {U_io_bind1}, {U_Python.Exceptions.{try4}1}, {U_Python.Exceptions.{try17}1}
...
def _idris_Python_46_Lib_46_Threading_46_wait(e0, e1):
  while True:
    return _idris_Python_46_Functions_46__36__46_(
      None,
      None,
      (1, (0,), (65747,)),  # Python.Telescope.Bind, Python.Telescope.Pi, {U_Python.Lib.Threading.{wait0}1}
      ...
      if fn0[0] < 65690:
          ...
          if fn0[0] < 65664:
            if fn0[0] < 65660:
              if fn0[0] < 65658:
                ...
                if fn0[0] == 65658:  # {U_Main.{main11}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65662:
                if fn0[0] == 65660:  # {U_Main.{main13}1}
                  P_c0 = fn0[1]
          ...
          if fn0[0] < 65681:
            ...
            if fn0[0] < 65685:
              if fn0[0] < 65683:
                ...
                else:  # {U_Main.{main33}1}
                  P_c0 = fn0[1]
                  return _idris_Main_46__123_main33_125_(P_c0, arg0)
              else:
                if fn0[0] == 65683:  # {U_Main.{main34}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65687:
                if fn0[0] == 65685:  # {U_Main.{main36}1}
                  P_c0 = fn0[1]
        ...
        if fn0[0] < 65707:
          if fn0[0] < 65698:
            if fn0[0] < 65694:
              if fn0[0] < 65692:
                ...
                else:  # {U_Main.{main41}1}
                  P_c0 = fn0[1]
                  return _idris_Main_46__123_main41_125_(P_c0, arg0)
              else:
                if fn0[0] == 65692:  # {U_Main.{main42}1}
                  P_c0, P_c1 = fn0[1:]
              ...
              if fn0[0] < 65696:
                if fn0[0] == 65694:  # {U_Main.{main44}1}
            ...
            if fn0[0] < 65702:
              ...
              if fn0[0] < 65704:
                ...
                elif fn0[0] == 65705:  # {U_Prelude.List.reverse, reverse'1}
                  P_c0, P_c1 = fn0[1:]
          ...
          if fn0[0] < 65716:
            if fn0[0] < 65711:
              if fn0[0] < 65709:
                if fn0[0] == 65707:  # {U_Prelude.Strings.{length0}1}
                ...
                if fn0[0] == 65709:  # {U_Python.Exceptions.{catch1}1}
              ...
              if fn0[0] < 65713:
                if fn0[0] == 65711:  # {U_Python.Exceptions.{catch3}1}
                ...
                if fn0[0] == 65713:  # {U_Python.Exceptions.{catch5}1}
                  return _idris_Python_46_Exceptions_46__123_catch5_125_(arg0)
                elif fn0[0] == 65714:  # {U_Python.Exceptions.{catch6}1}
                  P_c0 = fn0[1]
            ...
            if fn0[0] < 65720:
              if fn0[0] < 65718:
                if fn0[0] == 65716:  # {U_Python.Exceptions.{showException0}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65718:  # {U_Python.Exceptions.{try10}1}
              ...
              if fn0[0] < 65722:
                if fn0[0] == 65720:  # {U_Python.Exceptions.{try12}1}
                ...
                if fn0[0] == 65722:  # {U_Python.Exceptions.{try14}1}
                  return _idris_Python_46_Exceptions_46__123_try14_125_(arg0)
                elif fn0[0] == 65723:  # {U_Python.Exceptions.{try15}1}
      ...
      if fn0[0] < 65760:
        if fn0[0] < 65742:
          if fn0[0] < 65733:
            if fn0[0] < 65729:
              if fn0[0] < 65727:
                if fn0[0] == 65725:  # {U_Python.Exceptions.{try17}1}
                ...
                if fn0[0] == 65727:  # {U_Python.Exceptions.{try2}1}
              ...
              if fn0[0] < 65731:
                if fn0[0] == 65729:  # {U_Python.Exceptions.{try4}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65731:  # {U_Python.Exceptions.{try6}1}
            ...
            if fn0[0] < 65737:
              if fn0[0] < 65735:
                if fn0[0] == 65733:  # {U_Python.Exceptions.{try8}1}
                ...
                if fn0[0] == 65735:  # {U_Python.Fields.{/.0}1}
                  P_c0, P_c1 = fn0[1:]
              ...
              if fn0[0] < 65739:
                if fn0[0] == 65737:  # {U_Python.Functions.{$.0}1}
                ...
                if fn0[0] == 65739:  # {U_Python.IO.unRaw1}
                  P_c0 = fn0[1]
                  return _idris_Python_46_IO_46_unRaw(P_c0, arg0)
                elif fn0[0] == 65740:  # {U_Python.Lib.Threading.{forkPIO0}1}
          ...
          if fn0[0] < 65751:
            if fn0[0] < 65746:
              if fn0[0] < 65744:
                if fn0[0] == 65742:  # {U_Python.Lib.Threading.{forkPIO2}1}
                ...
                if fn0[0] == 65744:  # {U_Python.Lib.Threading.{forkPIO4}1}
                  P_c0 = fn0[1]
              ...
              if fn0[0] < 65748:
                if fn0[0] == 65746:  # {U_Python.Lib.Threading.{forkPIO6}1}
                  P_c0 = fn0[1]
                ...
                if fn0[0] == 65748:  # {U_Python.Prim.{Python.Prim.iterate:iter:0_____Python__Prim__idr_84_17_case_lam0}1}
                  P_c0, P_c1 = fn0[1:]
                ...
                elif fn0[0] == 65749:  # {U_Python.Prim.{collect0}1}
                  P_c0 = fn0[1]
            ...
            if fn0[0] < 65755:
              if fn0[0] < 65753:
                if fn0[0] == 65751:  # {U_Python.Prim.{foreach0}1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                ...
                if fn0[0] == 65753:  # {U_Python.Prim.{iterate0}1}
                  P_c0, P_c1 = fn0[1:]
              ...
              if fn0[0] < 65757:
                if fn0[0] == 65755:  # {U_Python.Prim.{next10}1}
                ...
                if fn0[0] == 65757:  # {U_Python.Prim.{next12}1}
                  return _idris_Python_46_Prim_46__123_next12_125_(arg0)
                elif fn0[0] == 65758:  # {U_Python.Prim.{next1}1}
        ...
        if fn0[0] < 65777:
          if fn0[0] < 65768:
            if fn0[0] < 65764:
              if fn0[0] < 65762:
                if fn0[0] == 65760:  # {U_Python.Prim.{next3}1}
                ...
                if fn0[0] == 65762:  # {U_Python.Prim.{next5}1}
              ...
              if fn0[0] < 65766:
                if fn0[0] == 65764:  # {U_Python.Prim.{next7}1}
                ...
                if fn0[0] == 65766:  # {U_Python.Prim.{next9}1}
            ...
            if fn0[0] < 65772:
              if fn0[0] < 65770:
                if fn0[0] == 65768:  # {U_Python.{marshalPIO0}1}
                  P_c0 = fn0[1]
          ...
          if fn0[0] < 65786:
            if fn0[0] < 65781:
              if fn0[0] < 65779:
                if fn0[0] == 65777:  # {U_{Python.Lib.Threading.forkPIO:worker:0_lam1}1}
                  P_c0 = fn0[1]
                  return _idris__123_Python_46_Lib_46_Threading_46_forkPIO_58_worker_58_0_95_lam1_125_(
                    P_c0, arg0
                  )
                else:  # {U_{Python.Prim.iterate:iter:0_lam0}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam0_125_(arg0)
              else:
                if fn0[0] == 65779:  # {U_{Python.Prim.iterate:iter:0_lam10}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam10_125_(arg0)
                else:  # {U_{Python.Prim.iterate:iter:0_lam11}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam11_125_(arg0)
            else:
              if fn0[0] < 65783:
                if fn0[0] == 65781:  # {U_{Python.Prim.iterate:iter:0_lam12}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam12_125_(arg0)
                else:  # {U_{Python.Prim.iterate:iter:0_lam13}1}
                  P_c0, P_c1, P_c2 = fn0[1:]
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam13_125_(
                    P_c0, P_c1, P_c2, arg0
                  )
              else:
                if fn0[0] == 65783:  # {U_{Python.Prim.iterate:iter:0_lam1}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam1_125_(arg0)
                elif fn0[0] == 65784:  # {U_{Python.Prim.iterate:iter:0_lam2}1}
                  P_c0 = fn0[1]
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam2_125_(P_c0, arg0)
                else:  # {U_{Python.Prim.iterate:iter:0_lam3}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam3_125_(arg0)
          else:
            if fn0[0] < 65790:
              if fn0[0] < 65788:
                if fn0[0] == 65786:  # {U_{Python.Prim.iterate:iter:0_lam4}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam4_125_(arg0)
                else:  # {U_{Python.Prim.iterate:iter:0_lam5}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam5_125_(arg0)
              else:
                if fn0[0] == 65788:  # {U_{Python.Prim.iterate:iter:0_lam6}1}
                  P_c0, P_c1 = fn0[1:]
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam6_125_(
                    P_c0, P_c1, arg0
                  )
                else:  # {U_{Python.Prim.iterate:iter:0_lam7}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam7_125_(arg0)
            else:
              if fn0[0] < 65792:
                if fn0[0] == 65790:  # {U_{Python.Prim.iterate:iter:0_lam8}1}
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam8_125_(arg0)
                else:  # {U_{Python.Prim.iterate:iter:0_lam9}1}
                  P_c0 = fn0[1]
                  return _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam9_125_(P_c0, arg0)
              else:
                if fn0[0] == 65792:  # {U_{io_bind1}1}
...
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam0_125_(in2):
  while True:
...
def _idris_Python_46_Prim_46__123_collect0_125_(in0, in1):
  while True:
    return (65770, None, None, in0.cons(in1))  # {U_io_return1}
...
def _idris_Prelude_46_Interactive_46__123_putStr_39_0_125_(in0):
  while True:
    return (65770, None, None, Unit)  # {U_io_return1}
...
def _idris__123_Python_46_Lib_46_Threading_46_forkPIO_58_worker_58_0_95_lam1_125_(
  ...
  while True:
    return _idris_Python_46_Functions_46__36__46_(
      None,
      None,
      (1, (0,), (65776,)),  # Python.Telescope.Bind, Python.Telescope.Pi, {U_{Python.Lib.Threading.forkPIO:worker:0_lam0}1}
...
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam1_125_(in1):
  while True:
    return (65778,)  # {U_{Python.Prim.iterate:iter:0_lam0}1}

# Python.Exceptions.{catch1}
def _idris_Python_46_Exceptions_46__123_catch1_125_(in1):
  while True:
    return (65708,)  # {U_Python.Exceptions.{catch0}1}

# Python.Prim.{collect1}
def _idris_Python_46_Prim_46__123_collect1_125_(in0):
  while True:
    return (65749, in0)  # {U_Python.Prim.{collect0}1}
...
def _idris_Python_46_Prim_46__123_foreach1_125_(e3, e4, e5, in0):
  while True:
    return _idris_Prelude_46_Functor_46_Prelude_46_Monad_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
      ...
      None,
      (65739, None),  # {U_Python.IO.unRaw1}
      (65751, e3, e4, e5)  # {U_Python.Prim.{foreach0}1}
    )

# Python.Lib.Threading.{forkPIO1}
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO1_125_(in0):
  while True:
    return (1, (2, 0), (65740,))  # Python.Telescope.Bind, Python.Telescope.Default, {U_Python.Lib.Threading.{forkPIO0}1}
...
def _idris_Python_46_Prim_46__123_next1_125_(in1):
  while True:
    return (65754,)  # {U_Python.Prim.{next0}1}
...
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam2_125_(in5, in6):
  while True:
...
def io_bind2(e0, e1, e2, e3, e4, _idris_w):
  while True:
    return (65792, e0, e1, e2, e3, e4, _idris_w)  # {U_{io_bind1}1}
...
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam3_125_(in5):
  while True:
    return (65784, in5)  # {U_{Python.Prim.iterate:iter:0_lam2}1}

# Python.Exceptions.{catch3}
def _idris_Python_46_Exceptions_46__123_catch3_125_(in5):
  while True:
    return (65710, in5)  # {U_Python.Exceptions.{catch2}1}

# Python.Lib.Threading.{forkPIO3}
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO3_125_(in3):
  while True:
    return (1, (0,), (65742,))  # Python.Telescope.Bind, Python.Telescope.Pi, {U_Python.Lib.Threading.{forkPIO2}1}
...
def _idris_Python_46_Prim_46__123_next3_125_(in5):
  while True:
    return (65759, in5)  # {U_Python.Prim.{next2}1}
...
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam4_125_(in4):
  while True:
    return (65785,)  # {U_{Python.Prim.iterate:iter:0_lam3}1}

# Python.Exceptions.{catch4}
def _idris_Python_46_Exceptions_46__123_catch4_125_(in4):
  while True:
    return (65711,)  # {U_Python.Exceptions.{catch3}1}
...
def _idris_Python_46_Prim_46__123_next4_125_(in4):
  while True:
    return (65760,)  # {U_Python.Prim.{next3}1}
...
def _idris_Python_46_Exceptions_46__123_try4_125_(e1, in0):
  while True:
    return _idris_try(
      e1,
      (65702, None, None, None, (65717,), (65726,)),  # {U_Prelude.Basics..1}, {U_Python.Exceptions.{try0}1}, {U_Python.Exceptions.{try1}1}
      (
        65702,  # {U_Prelude.Basics..1}
        None,
        None,
        None,
        (65702, None, None, None, (65727,), (65728,)),  # {U_Prelude.Basics..1}, {U_Python.Exceptions.{try2}1}, {U_Python.Exceptions.{try3}1}
        (65739, None)  # {U_Python.IO.unRaw1}
      )
    )

# {Python.Prim.iterate:iter:0_lam5}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam5_125_(in3):
  while True:
    return (65786,)  # {U_{Python.Prim.iterate:iter:0_lam4}1}

# Python.Exceptions.{catch5}
def _idris_Python_46_Exceptions_46__123_catch5_125_(in3):
  while True:
    return (65712,)  # {U_Python.Exceptions.{catch4}1}
...
def _idris_Python_46_Lib_46_Threading_46__123_forkPIO5_125_(in2, in5):
  while True:
    return (
      ...
      (65744, in2)  # {U_Python.Lib.Threading.{forkPIO4}1}
    )
...
def _idris_Python_46_Prim_46__123_next5_125_(in3):
  while True:
    return (65761,)  # {U_Python.Prim.{next4}1}

# Python.Exceptions.{try5}
def _idris_Python_46_Exceptions_46__123_try5_125_(in7):
  while True:
    return (65770, None, None, in7)  # {U_io_return1}

# {Python.Prim.iterate:iter:0_lam6}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam6_125_(e8, e10, in8):
  while True:
    return _idris_Python_46_Prim_46_iterate_58_iter_58_0(
...
def _idris_Python_46_Exceptions_46__123_catch6_125_(e2, in0):
  while True:
    if in0[0] == 1:  # Python.Exceptions.Except
      ...
      in9 = in0[1]
      aux1 = (0, (65709,), (65713,))  # constructor of Prelude.Monad.Monad, {U_Python.Exceptions.{catch1}1}, {U_Python.Exceptions.{catch5}1}
      assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
      in10, in11 = aux1[1:]
      aux2 = in10
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux2, None), in9)
    return _idris_error("unreachable due to case in tail position")
  ...
  while True:
    return (
      ...
      _idris_Python_46_Functions_46__36__58_(
        None,
        None,
        (1, (0,), (65743,)),  # Python.Telescope.Bind, Python.Telescope.Pi, {U_Python.Lib.Threading.{forkPIO3}1}
        _idris_Python_46_Fields_46__47__58_(
          None,
          None,
          (65767, None, u'threading'),  # {U_Python.importModule1}
          u'Thread',
          None
        ),
        None,
      ...
      (65745, in2)  # {U_Python.Lib.Threading.{forkPIO5}1}
    )
...
def _idris_Python_46_Exceptions_46__123_try6_125_(in6):
  while True:
    return (65730,)  # {U_Python.Exceptions.{try5}1}

# {Python.Prim.iterate:iter:0_lam7}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam7_125_(in2):
  while True:
    return (65770, None, None, in2)  # {U_io_return1}
...
def _idris_Python_46_Prim_46__123_next7_125_(in1):
  while True:
    return (65763,)  # {U_Python.Prim.{next6}1}

# Python.Exceptions.{try7}
def _idris_Python_46_Exceptions_46__123_try7_125_(in10, in11):
  while True:
    return (65769, None, None, None, in10, in11)  # {U_io_bind1}

# {Python.Prim.iterate:iter:0_lam8}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam8_125_(in1):
  while True:
    return (65789,)  # {U_{Python.Prim.iterate:iter:0_lam7}1}
...
def _idris_Python_46_Exceptions_46__123_try8_125_(in10):
  while True:
    return (65732, in10)  # {U_Python.Exceptions.{try7}1}

# {Python.Prim.iterate:iter:0_lam9}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam9_125_(in5, in6):
  while True:
    return (65769, None, None, None, in5, in6)  # {U_io_bind1}
...
def _idris_Python_46_Prim_46__123_next9_125_(in5):
  while True:
    return (65765, in5)  # {U_Python.Prim.{next8}1}

# Python.Exceptions.{try9}
def _idris_Python_46_Exceptions_46__123_try9_125_(in9):
  while True:
    return (65733,)  # {U_Python.Exceptions.{try8}1}

# {Python.Prim.iterate:iter:0_lam10}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam10_125_(in5):
  while True:
    return (65791, in5)  # {U_{Python.Prim.iterate:iter:0_lam9}1}
...
def _idris_Python_46_Prim_46__123_next10_125_(in4):
  while True:
    return (65766,)  # {U_Python.Prim.{next9}1}

# Python.Exceptions.{try10}
def _idris_Python_46_Exceptions_46__123_try10_125_(in8):
  while True:
    return (65734,)  # {U_Python.Exceptions.{try9}1}

# {Python.Prim.iterate:iter:0_lam11}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam11_125_(in4):
  while True:
    return (65779,)  # {U_{Python.Prim.iterate:iter:0_lam10}1}

# Main.{main11}
def _idris_Main_46__123_main11_125_(in11, in21):
  while True:
    return (65770, None, None, (in11 + 1))  # {U_io_return1}

# Python.Prim.{next11}
def _idris_Python_46_Prim_46__123_next11_125_(in3):
  while True:
    return (65755,)  # {U_Python.Prim.{next10}1}
...
# {Python.Prim.iterate:iter:0_lam12}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam12_125_(in3):
  while True:
    return (65780,)  # {U_{Python.Prim.iterate:iter:0_lam11}1}
  ...
  while True:
    return (
      ...
      _idris_Prelude_46_Interactive_46_putStr_39_(
        None,
        ((_idris_Prelude_46_Show_46_primNumShow(None, (65772,), (0,), (in11 + 1)) + (u'. ' + in20)) + u'\u000a')  # {U_prim__toStrInt1}, Prelude.Show.Open
      ),
  ...
  while True:
    if in0[0] == 1:  # Python.Exceptions.Except
      ...
      if in7[0] == 0:  # Python.Exceptions.StopIteration
        aux1 = (0, (65758,), (65762,))  # constructor of Prelude.Monad.Monad, {U_Python.Prim.{next1}1}, {U_Python.Prim.{next5}1}
        assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
        in9, in10 = aux1[1:]
        aux2 = in9
        return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux2, None), None)
      else:
        return _idris_Python_46_Exceptions_46_raise(None, in8)
      return _idris_error("unreachable due to case in tail position")
    else:  # Python.Exceptions.OK
      in11 = in0[1]
      aux3 = (0, (65764,), (65756,))  # constructor of Prelude.Monad.Monad, {U_Python.Prim.{next7}1}, {U_Python.Prim.{next11}1}
      assert aux3[0] == 0  # constructor of Prelude.Monad.Monad
      in12, in13 = aux3[1:]
      aux4 = in12
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux4, None), in11)
    return _idris_error("unreachable due to case in tail position")

# Python.Exceptions.{try12}
def _idris_Python_46_Exceptions_46__123_try12_125_(in6):
  while True:
    return (65719,)  # {U_Python.Exceptions.{try11}1}

# {Python.Prim.iterate:iter:0_lam13}
def _idris__123_Python_46_Prim_46_iterate_58_iter_58_0_95_lam13_125_(
  e10, e9, e8, in0
):
  while True:
      ...
      return APPLY0(
        APPLY0(
          _idris_Prelude_46_Monad_46__62__62__61_(
            None,
            (0, (65783,), (65787,)),  # constructor of Prelude.Monad.Monad, {U_{Python.Prim.iterate:iter:0_lam1}1}, {U_{Python.Prim.iterate:iter:0_lam5}1}
            None,
            None
          ),
          APPLY0(APPLY0(e10, e9), in7)
        ),
        (65788, e8, e10)  # {U_{Python.Prim.iterate:iter:0_lam6}1}
      )
    else:  # Prelude.Maybe.Nothing
      aux1 = (0, (65790,), (65781,))  # constructor of Prelude.Monad.Monad, {U_{Python.Prim.iterate:iter:0_lam8}1}, {U_{Python.Prim.iterate:iter:0_lam12}1}
      assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
      in9, in10 = aux1[1:]
      aux2 = in9
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux2, None), e9)
    return _idris_error("unreachable due to case in tail position")
...
def _idris_Python_46_Exceptions_46__123_try14_125_(in10):
  while True:
    return (65721, in10)  # {U_Python.Exceptions.{try13}1}
...
def _idris_Python_46_Exceptions_46__123_try15_125_(in9):
  while True:
    return (65722,)  # {U_Python.Exceptions.{try14}1}

# Main.{main16}
def _idris_Main_46__123_main16_125_(in29, in30):
  while True:
    return (65770, None, None, APPLY0(_idris_Prelude_46_Strings_46_length(), in29))  # {U_io_return1}

# Python.Exceptions.{try16}
def _idris_Python_46_Exceptions_46__123_try16_125_(in8):
  while True:
    return (65723,)  # {U_Python.Exceptions.{try15}1}
...
def _idris_Python_46_Exceptions_46__123_try17_125_(in5):
  while True:
    if in5[0] == 0:  # Prelude.Either.Left
      in12 = in5[1]
      aux1 = (0, (65731,), (65718,))  # constructor of Prelude.Monad.Monad, {U_Python.Exceptions.{try6}1}, {U_Python.Exceptions.{try10}1}
      assert aux1[0] == 0  # constructor of Prelude.Monad.Monad
      in13, in14 = aux1[1:]
      aux2 = in13
      return APPLY0(
        _idris_Prelude_46_Applicative_46_pure(None, aux2, None),
        (
      ...
      in15 = in5[1]
      aux3 = (0, (65720,), (65724,))  # constructor of Prelude.Monad.Monad, {U_Python.Exceptions.{try12}1}, {U_Python.Exceptions.{try16}1}
      assert aux3[0] == 0  # constructor of Prelude.Monad.Monad
      in16, in17 = aux3[1:]
      aux4 = in16
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux4, None), (0, in15))  # Python.Exceptions.OK
    return _idris_error("unreachable due to case in tail position")
...
def _idris_Main_46__123_main29_125_(in37):
  while True:
    return (65769, None, None, None, (65767, None, u'os'), (65676,))  # {U_io_bind1}, {U_Python.importModule1}, {U_Main.{main28}1}
...
def _idris_Main_46__123_main38_125_(in1, in22):
  while True:
    return (
      ...
      _idris_Prelude_46_Interactive_46_putStr_39_(
        None,
        ((u'Total number of features: ' + _idris_Prelude_46_Show_46_primNumShow(None, (65772,), (0,), in22)) + u'\u000a')  # {U_prim__toStrInt1}, Prelude.Show.Open
      ),
...
def _idris_Main_46__123_main43_125_(in1, in3):
  while True:
    return (65769, None, None, None, (65767, None, u'bs4'), (65692, in3, in1))  # {U_io_bind1}, {U_Python.importModule1}, {U_Main.{main42}1}
...
def _idris_Python_46_Lib_46_Threading_46_forkPIO_58_worker_58_0(e0, e1, e2):
  while True:
    return (65769, None, None, None, e1, (65777, e2))  # {U_io_bind1}, {U_{Python.Lib.Threading.forkPIO:worker:0_lam1}1}
...
def _idris_Python_46_Prim_46_iterate_58_iter_58_0(
  ...
  while True:
    return (
      ...
      (65782, e10, e9, e8)  # {U_{Python.Prim.iterate:iter:0_lam13}1}
    )
...
def _idris_Prelude_46_Functor_46_Prelude_46_Monad_46__64_Prelude_46_Functor_46_Functor_36_IO_39__32_ffi_58__33_map_58_0(
  ...
  while True:
    return (65769, None, None, None, e4, (65703, e3))  # {U_io_bind1}, {U_Prelude.Functor.{Prelude.Monad.@Prelude.Functor.Functor$IO' ffi:!map:0_lam0}1}
...
def _idris_Prelude_46_Show_46_Prelude_46_Show_46__64_Prelude_46_Show_46_Show_36_Nat_58__33_show_58_0(
  ...
  while True:
    return _idris_Prelude_46_Show_46_primNumShow(None, (65771,), (0,), e0)  # {U_prim__toStrBigInt1}, Prelude.Show.Open
...
def _idris_Python_46_Exceptions_46_try_95__95__95__95__95_Python_95__95_Exceptions_95__95_idr_95_106_95_16_95_case(
  ...
  while True:
    if e3[0] == 0:  # Prelude.Either.Left
      ...
      aux1 = in1
      return APPLY0(
        _idris_Prelude_46_Applicative_46_pure(None, aux1, None),
        (
          1,  # Python.Exceptions.Except
          _idris_Python_46_Exceptions_46_fromString(
            _idris_Python_46_Fields_46__47__46_(
      ...
      in4, in5 = e2[1:]
      aux2 = in4
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux2, None), (0, in3))  # Python.Exceptions.OK
    return _idris_error("unreachable due to case in tail position")
...
def _idris_Python_46_Exceptions_46_catch_95__95__95__95__95_Python_95__95_Exceptions_95__95_idr_95_130_95_16_95_case(
  ...
  while True:
    if e4[0] == 1:  # Python.Exceptions.Except
      ...
      in3, in4 = e3[1:]
      aux1 = in3
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux1, None), in2)
    return _idris_error("unreachable due to case in tail position")
  ...
  while True:
    if e3[0] == 1:  # Python.Exceptions.Except
      ...
      if in0[0] == 0:  # Python.Exceptions.StopIteration
        ...
        in2, in3 = e2[1:]
        aux1 = in2
        return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux1, None), None)
      else:
      ...
      in5, in6 = e2[1:]
      aux2 = in5
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux2, None), in4)
    return _idris_error("unreachable due to case in tail position")
  ...
  while True:
    if e12 is not None:  # Prelude.Maybe.Just
      ...
      return APPLY0(
        ...
        (65748, e8, e10)  # {U_Python.Prim.{Python.Prim.iterate:iter:0_____Python__Prim__idr_84_17_case_lam0}1}
      )
    else:  # Prelude.Maybe.Nothing
      assert e11[0] == 0  # constructor of Prelude.Monad.Monad
      in2, in3 = e11[1:]
      aux1 = in2
      return APPLY0(_idris_Prelude_46_Applicative_46_pure(None, aux1, None), e9)
    return _idris_error("unreachable due to case in tail position")
